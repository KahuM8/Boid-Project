...
void Application::renderGUI() {
	...
	//boid stuff
	if (ImGui::TreeNode("change me")) {
		ImGui::SliderFloat("local", &m_scene.local, 0, 10, "%.2f", 3.0f);
		ImGui::SliderFloat("maxSpeed", &m_scene.maxS, 0, 50, "%.2f", 3.0f);
		ImGui::SliderFloat("minSpeed", &m_scene.minS, 0, 20, "%.2f", 3.0f);
		ImGui::SliderFloat("maxAccel", &m_scene.maxAcc, 0, 20, "%.2f", 3.0f);
		//weights
		ImGui::SliderFloat("cohesionWeight", &m_scene.coher, 0, 10, "%.2f", 3.0f);
		ImGui::SliderFloat("allignmentWeight", &m_scene.align, 0, 10, "%.2f", 3.0f);
		ImGui::SliderFloat("avoidanceWeight", &m_scene.avoid, 0, 10, "%.2f", 3.0f);
		//pred stuff

		ImGui::SliderFloat("predatorAvoidanceWeight", &m_scene.predAvoid, 0, 100);
		ImGui::SliderFloat("predatorMinSpeed", &m_scene.predMinS, 0, 50);
		ImGui::SliderFloat("predatorMaxSpeed", &m_scene.predMaxS, 0, 50);
		ImGui::SliderFloat("predatorMaxAccel", &m_scene.predMaxAcc, 0, 50);
		ImGui::SliderFloat("predatorChase", &m_scene.predChace, 0, 500);
		ImGui::TreePop();
	}
